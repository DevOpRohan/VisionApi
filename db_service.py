...
async def handle_db_service(preset, chats):
    ...
    if ai_response.startswith("@engage:"):
        ...
        return {"exit": True, "response": "Well, that's all for now. Todo service stopped."}
